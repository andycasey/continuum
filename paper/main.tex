...
%In later sub-sections we discuss the specific choices made for the \emph{APOGEE} and \emph{BOSS} applications, but for now we discuss some general principles and practices that we found successful. 
