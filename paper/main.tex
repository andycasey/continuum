...
% TODO
% [X] Talk about BOSZ spectra and how the model was constructed.
% [X] Talk about how we constructed the telluric basis vectors
...
% TODO: anything else to say results-wise about experiment 1? \chi^2 values? systematic differences as a function of flux?
...
%\todo{Something about the NMF weights we find, and how they vary somewhat expectantly?}
...
%In subsequent works we discuss applications where this interpretability is exploited (Casey et al., in prep), but main.\\
...
If they do not become co-authors, then we should be sure to thank
    ...
    Megan Bedell (Flatiron Institute), and 
    Michael Blanton (NYU).
